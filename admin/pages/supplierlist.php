                                    ...
                                    <tbody>
                                      ...
                                      ?>
                                          <tr>
                                              ...
                                              <td><?php echo $result['suppAss']; ?></td>
                                              <td><?php echo $result['suppContact']; ?></td>
                                              <td><?php echo $result['suppMail']; ?></td>
                                              <td><?php echo $result['suppAddress']; ?></td>
                                              <td>
                                                <a href="supplieredit.php?supp=<?php echo $result['suppId']; ?>">
